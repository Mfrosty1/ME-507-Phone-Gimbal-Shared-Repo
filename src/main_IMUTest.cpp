...
void setup()
{
  ...
  // new code to try and switch pins
  // myWire.begin(2);                // join i2c bus with address #2
  // pinPeripheral(1, PIO_SERCOM);   //Assign SDA function to pin 1 (used to be 0)
  // pinPeripheral(2, PIO_SERCOM);   //Assign SCL function to pin 2 (used to be 1)
...
// Original code for pins D14 and D15
// WIRE_PORT.begin(); // original code
// WIRE_PORT.setClock(400000); // original code

// Code for getting I2C on pins A4 and A5
// Matthew has tried (3), (I2C3), (20, 19), (19, 20), (18, 19), (A4, A5), (PA4, PA5)
// WIRE_PORT.begin(PA4, PA5); // Matthew is trying this because why not
Wire2.begin();
...
// myICM.begin(WIRE_PORT, AD0_VAL); // original code
myICM.begin(Wire2, AD0_VAL); // matthew's attempts
